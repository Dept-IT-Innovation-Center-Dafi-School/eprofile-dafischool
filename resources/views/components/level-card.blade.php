...
<a href="{{ route('levels.show', $level->slug) }}"
   class="group flex flex-col h-full rounded-2xl overflow-hidden bg-white shadow-md ring-1 ring-slate-900/5 hover:shadow-xl hover:-translate-y-1 active:scale-95 transition duration-300 min-h-[44px]">
    <div class="aspect-[4/3] overflow-hidden relative shrink-0">
        @if ($level->image)
    ...
    <div class="flex flex-col flex-1 p-4 sm:p-5 border-t-2 border-gold-400">
        ...
        <span class="inline-flex items-center gap-1 mt-auto pt-3 text-gold-600 font-semibold text-sm group-hover:gap-2 transition-all">
